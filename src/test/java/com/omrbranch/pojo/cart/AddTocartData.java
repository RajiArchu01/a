...
public class AddTocartData {
	...
	public ArrayList<AddToCartVariation> getVariations() {
		return variations;
	}
	public void setVariations(ArrayList<AddToCartVariation> variations) {
    ...
    private ArrayList<AddToCartVariation> variations;

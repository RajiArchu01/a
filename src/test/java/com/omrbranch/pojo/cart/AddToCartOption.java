...
public class AddToCartOption {
	...
	public AddToCartAttributeOption getAttribute_option() {
		return attribute_option;
	}
	public void setAttribute_option(AddToCartAttributeOption attribute_option) {
    ...
    private AddToCartAttributeOption attribute_option;
}

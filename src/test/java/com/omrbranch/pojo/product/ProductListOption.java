...
public class ProductListOption {
	 private int id;
	    ...
	    private ProductListAttributeOption attribute_option;
		...
		public ProductListAttributeOption getAttribute_option() {
			return attribute_option;
		}
		public void setAttribute_option(ProductListAttributeOption attribute_option) {
